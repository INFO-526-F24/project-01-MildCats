...
-   We first append individual datasets of the same type to create a unified dataset that spans from 21-23
...
-   Saving the pre-processed and normalized dataset
...
-   This completes our data pre-processing part
