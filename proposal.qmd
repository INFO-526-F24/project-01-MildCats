...
The base of our data is formed by the Premier League match dataset for the years 2021 to 2022. This dataset is extended to cover matches from years \[\]. Then the longer dataset is augmented with the weather data during the Premier League schedule. Further, the entire schedule is supplemented with data of betting odds retrieved from popular betting site \[\]. The base of our data is formed by the Premier League match dataset for the years 2021 to 2022. This dataset is extended to cover matches from years \[\]. Then the longer dataset is augmented with the weather data during the Premier League schedule. Further, the entire schedule is supplemented with data of betting odds retrieved from popular betting site \[\].
