...
| **Column Name** | **Description**                                   | **Usage in Project**                                |
|------------------|---------------------------|---------------------------|
| **Date**        | Date of the match                                 | Used to align matches with weather and betting data |
| **HomeTeam**    | Name of the home team                             | Analyze home team performance                       |
| **AwayTeam**    | Name of the away team                             | Compare with home team performance                  |
| **FTHG**        | Full-time home goals                              | Key for match outcome analysis                      |
| **FTAG**        | Full-time away goals                              | Key for match outcome analysis                      |
| **FTR**         | Full-time result (H=Home Win, D=Draw, A=Away Win) | Evaluate outcome trends and betting accuracy        |
| **HS**          | Home team shots                                   | Analyze team performance metrics                    |
| **AS**          | Away team shots                                   | Analyze team performance metrics                    |
...
| **Column Name** | **Description**                  | **Usage in Project**                                         |
|------------------|---------------------------|---------------------------|
| **datetime**    | Timestamp of weather data        | Align weather with match date                                |
| **tempmax**     | Maximum temperature on match day | Analyze impact of temperature on match outcomes              |
| **tempmin**     | Minimum temperature on match day | Analyze impact of temperature fluctuations                   |
| **precip**      | Precipitation (in mm)            | Evaluate how weather impacts match performance               |
| **windspeed**   | Speed of wind on match day       | Analyze influence of wind on match results                   |
| **humidity**    | Humidity on match day            | Investigate correlations between humidity and match outcomes |
| **visibility**  | Visibility during match          | Explore effects of low visibility on performance             |
...
| **Column Name** | **Description**                | **Usage in Project**                                            |
|----------------|----------------------------|----------------------------|
| **HomeTeam**    | Name of the home team          | Compare betting odds to actual results                          |
| **AwayTeam**    | Name of the away team          | Compare betting odds to actual results                          |
| **B365H**       | Bet365 odds for home team win  | Analyze accuracy of betting odds                                |
| **B365D**       | Bet365 odds for a draw         | Analyze odds dynamics for tied matches                          |
| **B365A**       | Bet365 odds for away team win  | Compare odds with actual match outcome                          |
| **MaxH**        | Maximum odds for home team win | Track the highest betting odds and its correlation with results |
| **MaxA**        | Maximum odds for away team win | Track the highest betting odds and its correlation with results |
...
-   More details on the analysis plan shall be added here as the work progresses.
