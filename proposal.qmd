...
Update during Milestone 3

-   We have 3 major analysis directions we'd like to explore:

    -   **Extreme Weather and Betting Odds** -
    -   **The Accuracy of Odds** -
    -   **Referee-Team Bias** -

-   Each task will be assigned to be explored by 2-3 team members. Each subteam will complete their data analysis task, and formulate a sketch as to how best to visualize their results.
