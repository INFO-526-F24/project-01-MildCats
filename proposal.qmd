...
-   **Weather**
    ...
    -   **Ethical Considerations -**
        ...
        -   The data was not manipulated at any point, thus allowing transparency and clear documentation of the process.
...
1.  How do extreme pre-match weather conditions (such as heavy rain, strong winds, or cold temperatures) influence the likelihood of surprising outcomes, such as underdog victories, and how do betting odds before the match reflect these potential surprises compared to historical odds for the same teams?
    -   **Rationale**: This question aims to explore whether extreme weather conditions lead to more unexpected outcomes, such as underdogs winning. It also examines how pre-match betting odds account for these potential disruptions, by comparing them to odds for the same teams in previous matches under normal conditions. This will help determine whether bookmakers adjust their odds in response to extreme weather, and how well these adjustments predict surprising results.
    -   **Datasets involved**: Match data, weather data, betting odds.
2.  How do different weather conditions (such as rain, wind, or temperature) impact Premier League match outcomes, and to what extent do pre-match betting odds take these weather factors into account?
    -   **Rationale**: We want to explore how weather influences match results, looking specifically at whether certain conditions lead to more unexpected outcomes. We’re also interested in seeing how well pre-match betting odds reflect the potential impact of weather on performance, helping us understand if bookies accurately anticipate these effects.
    -   **Datasets involved**: Match data, weather data, betting odds.

## Analysis plan

-   We are still working on the Analysis plan will keep updating the proposal as and when we progress through the project. Status updates can be found over this [document](https://docs.google.com/spreadsheets/d/1a_E8TZVmqjrWEYpPCJDA2rBPvrxk70A2HlkklfOmul0/edit?gid=0#gid=0).\
